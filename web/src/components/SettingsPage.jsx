        ...
        <section aria-label="Resume">
          ...
          {resumeFile ? (
            ...
            <div
              ...
              className={`rounded-xl border-2 border-dashed px-6 py-8 flex flex-col items-center gap-3 transition-colors ${
                isDragging
                  ? 'border-accent bg-accent/5'
                  : 'border-chrome-border bg-chrome-surface hover:border-chrome-muted'
              }`}
            >
              <div className="w-10 h-10 rounded-xl bg-chrome-deep flex items-center justify-center">
