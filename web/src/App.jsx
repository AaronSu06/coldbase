...
export default function App() {
  ...
  const activeCount = useMemo(() => records.filter(r => !r.archived).length, [records]);
                    ...
                    {filtered.map(r => (
                      ...
                      >
                        ...
                        <td className="py-2.5 font-mono text-[12px] text-gray-400">
                          {r.sentDate ? new Date(r.sentDate).toLocaleDateString(undefined, { month: 'short', day: 'numeric', year: 'numeric' }) : '—'}
                        </td>
                      </tr>
                    ))}
                  </tbody>
